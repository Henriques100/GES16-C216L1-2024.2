...
def main():
    ...
    estoque = [] # Estoque compartilhado entre os menus
    ...
    while True:
        ...
        if controlador == '1':
            ...
            menu_acessorios_bicicleta(estoque)

        elif controlador == '3':

            menu_tenis_esportivos(estoque)

        elif controlador == '4':

            menu_suplementos_alimentares(estoque)

        elif controlador == '5':

            menu_smartbands(estoque)    

        elif controlador == '6':

            menu_relogios_fitness(estoque)

        elif controlador == '7':

            menu_equipamentos_musculacao(estoque)

        elif controlador == '8':

            menu_patins_acessorios(estoque)                        
